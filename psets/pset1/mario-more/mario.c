/*
    This program outputs a complex mario pyramid of desired size.
...
int main(void)
{
    ...
    for (int i = 1; i <= height; i++)
    {
        ...
        //This prints the space between the two pyramids.
        printf("  ");

        //This prints the hashes required for the second pyramid in the current line.
        for (int hash = 1; hash <= i; hash++)
        {
            printf("#");
        }
